...
export const SYSTEMS = [
  ...
  },
  {
    ...
    sun:  {
      ...
      temp:  '5,778 K',
      color: '#ffd060',
      description: `An unremarkable yellow main-sequence star anchoring the planetary arrangement designated System X. Long observed by Imperial cartography but never visited in the modern era; preliminary surveys confirm parameters essentially identical to the empire's home star of legend.\n\nKarath's chief distinction is administrative rather than astrophysical: it was the empire's first long-range cartographic confirmation of life-bearing systems in the outer sectors, and its catalogue entry initiated the present round of expansion.`,
    },
    planets: [
      {
        name: 'Verath', climate: 'Scorched / Barren', distAU: 0.39, speed: 0.00090, r: 5, color: '#b87040', moons: [],
        description: `Innermost world of System X. A scorched, barren rock with surface temperatures regularly exceeding nine hundred kelvin on the dayside. No atmosphere of note. The crust is iron-rich and tectonically dead.\n\nOf academic interest only, though several metallurgical concessions have been informally proposed in council. None has yet been ratified.`,
      },
      {
      ...
      },
      {
        ...
        description: `A frozen ice giant in the outer reaches of System X. Methane and ammonia dominate the upper atmosphere. Surface — to whatever extent that word is meaningful here — temperature below eighty kelvin.\n\nNothing is known of its interior. Survey priority: low.`,
      },
      {
        name: 'Nethis', climate: 'Ice Giant / Methane', distAU: 8.00, speed: 0.000040, r: 12, color: '#4a6ab4', moons: [],
        description: `A methane-rich ice giant with a distinct deep-blue colouration. The outermost gas world in System X. Its axial tilt is anomalously steep, suggesting a violent event in its early history; theories remain speculative.\n\nLong-period oscillations in its orbit have been detected but not yet explained.`,
      },
      {
...
// ── Backward compat exports (System X) ────────────────────────────────────────
...
// Order is fixed to preserve old indices (System X planets 0–8, sun 9):
//   0–8  : System X planets
//   9    : System X sun (Karath)
//   10   : Throne System sun (Novaraya)
//   11   : Throne System planet (Throneworld)
//   12   : Throne System moon (The Ecumenologion)
function buildTargets() {
  const out = []
  // System X always comes first — planets then sun — to keep old SUN_IDX = 9
