...
O Star-Hearèr, we are the chord beneath thy hand.*`,
      ...
      entry('the-empress', 'The Empress', [
          ...
          `The current Empress is Iliantha III, the third of her regnal name and the twenty-eighth to ascend in the present reckoning. She has now reigned for twenty-four years. She was raised in the cloister as the second in the line of succession; her elder sister, the heir presumptive, declined the throne at the death of their mother and entered a contemplative order at the Litania Magna instead, where she lives still, and to which Iliantha is said to write in private several times a year. The reign of Iliantha III has been, in the established manner of the two prior Empresses to bear the name, a reign of diplomacy and consolidation rather than of war. The Annunciator has not spoken in her time. The fleet has performed no engagement worthy of remembrance. Her preferred instruments of governance are the audience, the treaty, and the long private session with the Ecumenologion.`,
        ], 'empressPanelVisited',
