// Copied from src/components/UrgentMessageOverlay.jsx so the battle sim owns its
// own urgent-transmission overlay (styles live in battle.css). Kept in sync with
// the legacy component's behaviour: typewriter body, **bold** / !!highlight!! /
// ##red## markup, and an ACKNOWLEDGE dismiss.
